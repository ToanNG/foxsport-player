...
function wz(a,b,c,d){var e,f,g;if(!b)throw new OI('authorization may not be null.');if(!c)throw new OI('configuration may not be null.');this.d='http://data.userprofile.community.theplatform.com/userprofile';LJ(this.d,MS)||(this.d+=MS);this.g=!a?aR:aR+a.b+sT+a.c+sT+a.d;this.f=new HB(d,this.d+(e=this.rb().e,f=UJ(e,tT,0),g=f.length>0?f[f.length-1]:aR,'data/'+g),this.g,b);if(c.d){this.e=c.d;DB(this.f,this.e)}c.c!=null&&CB(c);c.b!=null&&undefined}
