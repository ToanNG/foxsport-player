...
v[Db]=function(){return String($pdk.env.Detect.getInstance().hasFlash())};u[Db]={'false':0,'true':1};v[Eb]=function(){return String($pdk.env.Detect.getInstance().hasJquery())};u[Eb]={'false':0,'true':1};v[Fb]=function(){var a=$pdk.env.Detect.getInstance().getConfigSet(Gb);return a&&a.contains(Hb)?Ib:Jb};u[Fb]={'false':0,'true':1};v[Kb]=function(){var b=navigator.userAgent.toLowerCase();var c=function(a){return parseInt(a[1])*1000+parseInt(a[2])};if(function(){return b.indexOf(Lb)!=-1&&b.indexOf(Mb)!=-1||b.indexOf(Nb)!=-1}()){{m.$pdk.userAgentAxis=Ob;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(Pb)!=-1||b.indexOf(Qb)!=-1}()){{m.$pdk.userAgentAxis=Rb;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(Lb)!=-1&&(b.indexOf(Pb)==-1&&(b.indexOf(Qb)==-1&&b.indexOf(Nb)==-1))}()){{m.$pdk.userAgentAxis=Sb;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(Tb)!=-1}()){{m.$pdk.userAgentAxis=Tb;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(Ub)!=-1}()){{m.$pdk.userAgentAxis=Vb;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(Wb)!=-1}()){{m.$pdk.userAgentAxis=Xb;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(Mb)==-1&&(b.indexOf(Nb)==-1&&(b.indexOf(Nb)==-1&&(b.indexOf(Yb)!=-1&&b.indexOf(Zb)!=-1)))}()){{m.$pdk.userAgentAxis=$b;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(Mb)==-1&&(b.indexOf(Nb)==-1&&(b.indexOf(_b)!=-1&&b.indexOf(Zb)!=-1))}()){{m.$pdk.userAgentAxis=ac;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(Nb)==-1&&(b.indexOf(Lb)==-1&&((b.indexOf(Yb)!=-1||b.indexOf(bc)!=-1)&&b.indexOf(Mb)!=-1))}()){{m.$pdk.userAgentAxis=cc;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(Nb)==-1&&(b.indexOf(_b)!=-1&&b.indexOf(Mb)!=-1)}()){{m.$pdk.userAgentAxis=dc;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(ec)!=-1&&(b.indexOf(fc)!=-1&&n.documentMode>=10)}()){{m.$pdk.userAgentAxis=gc;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(ec)!=-1&&n.documentMode>=10}()){{m.$pdk.userAgentAxis=hc;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(ec)!=-1&&n.documentMode>=9}()){{m.$pdk.userAgentAxis=ic;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(ec)!=-1&&n.documentMode>=8}()){{m.$pdk.userAgentAxis=jc;return m.$pdk.userAgentAxis}}if(function(){var a=/msie ([0-9]+)\.([0-9]+)/.exec(b);if(a&&a.length==3)return c(a)>=6000}()){{m.$pdk.userAgentAxis=kc;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(lc)!=-1&&b.indexOf(_b)!=-1}()){{m.$pdk.userAgentAxis=mc;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(lc)!=-1&&(b.indexOf(Yb)!=-1||b.indexOf(bc)!=-1)}()){{m.$pdk.userAgentAxis=nc;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(lc)!=-1}()){{m.$pdk.userAgentAxis=oc;return m.$pdk.userAgentAxis}}m.$pdk.userAgentAxis=cc;return cc};u[Kb]={chrome_android:0,chrome_mac:1,chrome_windows:2,gecko1_8:3,gecko1_8_mac:4,gecko1_8_windows:5,ie10:6,ie10_app:7,ie6:8,ie8:9,ie9:10,opera:11,safari:12,safari_android:13,safari_android_legacy:14,safari_ipad:15,safari_iphone:16,safari_mac:17,safari_windows:18};PDK.onScriptLoad=function(a){PDK.onScriptLoad=null;q=a;G()};if(F()){alert(pc+qc);return}I();H();o&&o({moduleName:V,sessionId:p,subSystem:W,evtGroup:X,millis:(new Date).getTime(),type:rc});var M;try{K([Jb,Ib,Jb,kc],sc);K([Jb,Ib,Ib,kc],sc);K([Jb,Ib,Jb,kc],sc+tc);K([Jb,Ib,Ib,kc],sc+tc);K([Ib,Jb,Jb,Tb],uc);K([Ib,Jb,Ib,Tb],uc);K([Ib,Jb,Jb,Tb],uc+tc);K([Ib,Jb,Ib,Tb],uc+tc);K([Ib,Jb,Jb,oc],vc);K([Ib,Jb,Ib,oc],vc);K([Ib,Jb,Jb,oc],vc+tc);K([Ib,Jb,Ib,oc],vc+tc);K([Ib,Jb,Jb,nc],wc);K([Ib,Jb,Ib,nc],wc);K([Ib,Jb,Jb,nc],wc+tc);K([Ib,Jb,Ib,nc],wc+tc);K([Ib,Jb,Jb,dc],xc);K([Ib,Jb,Ib,dc],xc);K([Ib,Jb,Jb,dc],xc+tc);K([Ib,Jb,Ib,dc],xc+tc);K([Jb,Jb,Jb,$b],yc);K([Jb,Jb,Ib,$b],yc);K([Jb,Jb,Jb,$b],yc+tc);K([Jb,Jb,Ib,$b],yc+tc);K([Ib,Ib,Jb,kc],zc);K([Ib,Ib,Ib,kc],zc);K([Ib,Ib,Jb,kc],zc+tc);K([Ib,Ib,Ib,kc],zc+tc);K([Ib,Jb,Jb,cc],Ac);K([Ib,Jb,Ib,cc],Ac);K([Ib,Jb,Jb,cc],Ac+tc);K([Ib,Jb,Ib,cc],Ac+tc);K([Ib,Ib,Jb,Zb],Bc);K([Ib,Ib,Ib,Zb],Bc);K([Ib,Ib,Jb,Zb],Bc+tc);K([Ib,Ib,Ib,Zb],Bc+tc);K([Ib,Jb,Jb,kc],Cc);K([Ib,Jb,Ib,kc],Cc);K([Ib,Jb,Jb,kc],Cc+tc);K([Ib,Jb,Ib,kc],Cc+tc);K([Jb,Ib,Jb,$b],Dc);K([Jb,Ib,Ib,$b],Dc);K([Jb,Ib,Jb,$b],Dc+tc);K([Jb,Ib,Ib,$b],Dc+tc);K([Ib,Ib,Jb,cc],Ec);K([Ib,Ib,Ib,cc],Ec);K([Ib,Ib,Jb,cc],Ec+tc);K([Ib,Ib,Ib,cc],Ec+tc);K([Ib,Jb,Jb,jc],Fc);K([Ib,Jb,Ib,jc],Fc);K([Ib,Jb,Jb,jc],Fc+tc);K([Ib,Jb,Ib,jc],Fc+tc);K([Jb,Jb,Jb,Sb],Gc);K([Jb,Jb,Ib,Sb],Gc);K([Jb,Jb,Jb,Sb],Gc+tc);K([Jb,Jb,Ib,Sb],Gc+tc);K([Jb,Jb,Jb,Tb],Hc);K([Jb,Jb,Ib,Tb],Hc);K([Jb,Jb,Jb,Tb],Hc+tc);K([Jb,Jb,Ib,Tb],Hc+tc);K([Ib,Ib,Jb,Vb],Ic);K([Ib,Ib,Ib,Vb],Ic);K([Ib,Ib,Jb,Vb],Ic+tc);K([Ib,Ib,Ib,Vb],Ic+tc);K([Jb,Ib,Jb,Rb],Jc);K([Jb,Ib,Ib,Rb],Jc);K([Jb,Ib,Jb,Rb],Jc+tc);K([Jb,Ib,Ib,Rb],Jc+tc);K([Ib,Ib,Jb,nc],Kc);K([Ib,Ib,Ib,nc],Kc);K([Ib,Ib,Jb,nc],Kc+tc);K([Ib,Ib,Ib,nc],Kc+tc);K([Jb,Ib,Jb,Zb],Lc);K([Jb,Ib,Ib,Zb],Lc);K([Jb,Ib,Jb,Zb],Lc+tc);K([Jb,Ib,Ib,Zb],Lc+tc);K([Ib,Jb,Jb,Xb],Mc);K([Ib,Jb,Ib,Xb],Mc);K([Ib,Jb,Jb,Xb],Mc+tc);K([Ib,Jb,Ib,Xb],Mc+tc);K([Jb,Jb,Jb,hc],Nc);K([Jb,Jb,Ib,hc],Nc);K([Jb,Jb,Jb,hc],Nc+tc);K([Jb,Jb,Ib,hc],Nc+tc);K([Jb,Ib,Jb,Ob],Oc);K([Jb,Ib,Ib,Ob],Oc);K([Jb,Ib,Jb,Ob],Oc+tc);K([Jb,Ib,Ib,Ob],Oc+tc);K([Ib,Ib,Jb,jc],Pc);K([Ib,Ib,Ib,jc],Pc);K([Ib,Ib,Jb,jc],Pc+tc);K([Ib,Ib,Ib,jc],Pc+tc);K([Jb,Jb,Jb,gc],Qc);K([Jb,Jb,Ib,gc],Qc);K([Jb,Jb,Jb,gc],Qc+tc);K([Jb,Jb,Ib,gc],Qc+tc);K([Jb,Ib,Jb,gc],Rc);K([Jb,Ib,Ib,gc],Rc);K([Jb,Ib,Jb,gc],Rc+tc);K([Jb,Ib,Ib,gc],Rc+tc);K([Jb,Ib,Jb,Xb],Sc);K([Jb,Ib,Ib,Xb],Sc);K([Jb,Ib,Jb,Xb],Sc+tc);K([Jb,Ib,Ib,Xb],Sc+tc);K([Ib,Ib,Jb,Sb],Tc);K([Ib,Ib,Ib,Sb],Tc);K([Ib,Ib,Jb,Sb],Tc+tc);K([Ib,Ib,Ib,Sb],Tc+tc);K([Ib,Ib,Jb,gc],Uc);K([Ib,Ib,Ib,gc],Uc);K([Ib,Ib,Jb,gc],Uc+tc);K([Ib,Ib,Ib,gc],Uc+tc);K([Ib,Jb,Jb,Sb],Vc);K([Ib,Jb,Ib,Sb],Vc);K([Ib,Jb,Jb,Sb],Vc+tc);K([Ib,Jb,Ib,Sb],Vc+tc);K([Ib,Ib,Jb,$b],Wc);K([Ib,Ib,Ib,$b],Wc);K([Ib,Ib,Jb,$b],Wc+tc);K([Ib,Ib,Ib,$b],Wc+tc);K([Jb,Jb,Jb,ic],Xc);K([Jb,Jb,Ib,ic],Xc);K([Jb,Jb,Jb,ic],Xc+tc);K([Jb,Jb,Ib,ic],Xc+tc);K([Jb,Jb,Jb,Vb],Yc);K([Jb,Jb,Ib,Vb],Yc);K([Jb,Jb,Jb,Vb],Yc+tc);K([Jb,Jb,Ib,Vb],Yc+tc);K([Jb,Jb,Jb,jc],Zc);K([Jb,Jb,Ib,jc],Zc);K([Jb,Jb,Jb,jc],Zc+tc);K([Jb,Jb,Ib,jc],Zc+tc);K([Ib,Jb,Jb,ic],$c);K([Ib,Jb,Ib,ic],$c);K([Ib,Jb,Jb,ic],$c+tc);K([Ib,Jb,Ib,ic],$c+tc);K([Jb,Ib,Jb,cc],_c);K([Jb,Ib,Ib,cc],_c);K([Jb,Ib,Jb,cc],_c+tc);K([Jb,Ib,Ib,cc],_c+tc);K([Ib,Ib,Jb,Xb],ad);K([Ib,Ib,Ib,Xb],ad);K([Ib,Ib,Jb,Xb],ad+tc);K([Ib,Ib,Ib,Xb],ad+tc);K([Ib,Ib,Jb,Ob],bd);K([Ib,Ib,Ib,Ob],bd);K([Ib,Ib,Jb,Ob],bd+tc);K([Ib,Ib,Ib,Ob],bd+tc);K([Ib,Jb,Jb,hc],cd);K([Ib,Jb,Ib,hc],cd);K([Ib,Jb,Jb,hc],cd+tc);K([Ib,Jb,Ib,hc],cd+tc);K([Jb,Ib,Jb,Tb],dd);K([Jb,Ib,Ib,Tb],dd);K([Jb,Ib,Jb,Tb],dd+tc);K([Jb,Ib,Ib,Tb],dd+tc);K([Jb,Jb,Jb,mc],ed);K([Jb,Jb,Ib,mc],ed);K([Jb,Jb,Jb,mc],ed+tc);K([Jb,Jb,Ib,mc],ed+tc);K([Ib,Ib,Jb,dc],fd);K([Ib,Ib,Ib,dc],fd);K([Ib,Ib,Jb,dc],fd+tc);K([Ib,Ib,Ib,dc],fd+tc);K([Jb,Ib,Jb,Vb],gd);K([Jb,Ib,Ib,Vb],gd);K([Jb,Ib,Jb,Vb],gd+tc);K([Jb,Ib,Ib,Vb],gd+tc);K([Ib,Jb,Jb,Zb],hd);K([Ib,Jb,Ib,Zb],hd);K([Ib,Jb,Jb,Zb],hd+tc);K([Ib,Jb,Ib,Zb],hd+tc);K([Ib,Ib,Jb,hc],jd);K([Ib,Ib,Ib,hc],jd);K([Ib,Ib,Jb,hc],jd+tc);K([Ib,Ib,Ib,hc],jd+tc);K([Ib,Jb,Jb,Ob],kd);K([Ib,Jb,Ib,Ob],kd);K([Ib,Jb,Jb,Ob],kd+tc);K([Ib,Jb,Ib,Ob],kd+tc);K([Jb,Ib,Jb,mc],ld);K([Jb,Ib,Ib,mc],ld);K([Jb,Ib,Jb,mc],ld+tc);K([Jb,Ib,Ib,mc],ld+tc);K([Ib,Jb,Jb,Rb],md);K([Ib,Jb,Ib,Rb],md);K([Ib,Jb,Jb,Rb],md+tc);K([Ib,Jb,Ib,Rb],md+tc);K([Jb,Jb,Jb,kc],nd);K([Jb,Jb,Ib,kc],nd);K([Jb,Jb,Jb,kc],nd+tc);K([Jb,Jb,Ib,kc],nd+tc);K([Jb,Jb,Jb,Ob],od);K([Jb,Jb,Ib,Ob],od);K([Jb,Jb,Jb,Ob],od+tc);K([Jb,Jb,Ib,Ob],od+tc);K([Jb,Ib,Jb,hc],pd);K([Jb,Ib,Ib,hc],pd);K([Jb,Ib,Jb,hc],pd+tc);K([Jb,Ib,Ib,hc],pd+tc);K([Ib,Jb,Jb,mc],qd);K([Ib,Jb,Ib,mc],qd);K([Ib,Jb,Jb,mc],qd+tc);K([Ib,Jb,Ib,mc],qd+tc);K([Jb,Jb,Jb,Zb],rd);K([Jb,Jb,Ib,Zb],rd);K([Jb,Jb,Jb,Zb],rd+tc);K([Jb,Jb,Ib,Zb],rd+tc);K([Jb,Ib,Jb,oc],sd);K([Jb,Ib,Ib,oc],sd);K([Jb,Ib,Jb,oc],sd+tc);K([Jb,Ib,Ib,oc],sd+tc);K([Jb,Jb,Jb,cc],td);K([Jb,Jb,Ib,cc],td);K([Jb,Jb,Jb,cc],td+tc);K([Jb,Jb,Ib,cc],td+tc);K([Ib,Jb,Jb,Vb],ud);K([Ib,Jb,Ib,Vb],ud);K([Ib,Jb,Jb,Vb],ud+tc);K([Ib,Jb,Ib,Vb],ud+tc);K([Jb,Ib,Jb,Sb],vd);K([Jb,Ib,Ib,Sb],vd);K([Jb,Ib,Jb,Sb],vd+tc);K([Jb,Ib,Ib,Sb],vd+tc);K([Jb,Jb,Jb,nc],wd);K([Jb,Jb,Ib,nc],wd);K([Jb,Jb,Jb,nc],wd+tc);K([Jb,Jb,Ib,nc],wd+tc);K([Jb,Ib,Jb,nc],xd);K([Jb,Ib,Ib,nc],xd);K([Jb,Ib,Jb,nc],xd+tc);K([Jb,Ib,Ib,nc],xd+tc);K([Ib,Ib,Jb,mc],yd);K([Ib,Ib,Ib,mc],yd);K([Ib,Ib,Jb,mc],yd+tc);K([Ib,Ib,Ib,mc],yd+tc);K([Jb,Jb,Jb,dc],zd);K([Jb,Jb,Ib,dc],zd);K([Jb,Jb,Jb,dc],zd+tc);K([Jb,Jb,Ib,dc],zd+tc);K([Ib,Ib,Jb,Rb],Ad);K([Ib,Ib,Ib,Rb],Ad);K([Ib,Ib,Jb,Rb],Ad+tc);K([Ib,Ib,Ib,Rb],Ad+tc);K([Ib,Ib,Jb,ic],Bd);K([Ib,Ib,Ib,ic],Bd);K([Ib,Ib,Jb,ic],Bd+tc);K([Ib,Ib,Ib,ic],Bd+tc);K([Jb,Jb,Jb,ac],Cd);K([Jb,Jb,Ib,ac],Cd);K([Jb,Jb,Jb,ac],Cd+tc);K([Jb,Jb,Ib,ac],Cd+tc);K([Ib,Ib,Jb,oc],Dd);K([Ib,Ib,Ib,oc],Dd);K([Ib,Ib,Jb,oc],Dd+tc);K([Ib,Ib,Ib,oc],Dd+tc);K([Ib,Jb,Jb,ac],Ed);K([Ib,Jb,Ib,ac],Ed);K([Ib,Jb,Jb,ac],Ed+tc);K([Ib,Jb,Ib,ac],Ed+tc);K([Jb,Jb,Jb,Rb],Fd);K([Jb,Jb,Ib,Rb],Fd);K([Jb,Jb,Jb,Rb],Fd+tc);K([Jb,Jb,Ib,Rb],Fd+tc);K([Jb,Ib,Jb,ic],Gd);K([Jb,Ib,Ib,ic],Gd);K([Jb,Ib,Jb,ic],Gd+tc);K([Jb,Ib,Ib,ic],Gd+tc);K([Jb,Ib,Jb,dc],Hd);K([Jb,Ib,Ib,dc],Hd);K([Jb,Ib,Jb,dc],Hd+tc);K([Jb,Ib,Ib,dc],Hd+tc);K([Ib,Jb,Jb,gc],Id);K([Ib,Jb,Ib,gc],Id);K([Ib,Jb,Jb,gc],Id+tc);K([Ib,Jb,Ib,gc],Id+tc);K([Ib,Jb,Jb,$b],Jd);K([Ib,Jb,Ib,$b],Jd);K([Ib,Jb,Jb,$b],Jd+tc);K([Ib,Jb,Ib,$b],Jd+tc);K([Ib,Ib,Jb,Tb],Kd);K([Ib,Ib,Ib,Tb],Kd);K([Ib,Ib,Jb,Tb],Kd+tc);K([Ib,Ib,Ib,Tb],Kd+tc);K([Jb,Ib,Jb,jc],Ld);K([Jb,Ib,Ib,jc],Ld);K([Jb,Ib,Jb,jc],Ld+tc);K([Jb,Ib,Ib,jc],Ld+tc);K([Ib,Ib,Jb,ac],Md);K([Ib,Ib,Ib,ac],Md);K([Ib,Ib,Jb,ac],Md+tc);K([Ib,Ib,Ib,ac],Md+tc);K([Jb,Jb,Jb,oc],Nd);K([Jb,Jb,Ib,oc],Nd);K([Jb,Jb,Jb,oc],Nd+tc);K([Jb,Jb,Ib,oc],Nd+tc);K([Jb,Ib,Jb,ac],Od);K([Jb,Ib,Ib,ac],Od);K([Jb,Ib,Jb,ac],Od+tc);K([Jb,Ib,Ib,ac],Od+tc);K([Jb,Jb,Jb,Xb],Pd);K([Jb,Jb,Ib,Xb],Pd);K([Jb,Jb,Jb,Xb],Pd+tc);K([Jb,Jb,Ib,Xb],Pd+tc);M=w[L(Db)][L(Eb)][L(Fb)][L(Kb)];var N=M.indexOf(Qd);if(N!=-1){A=Number(M.substring(N+1));M=M.substring(0,N)}}catch(a){return}var O;function P(){if(!r){r=true;G();if(n.removeEventListener){n.removeEventListener(Rd,P,false)}if(O){clearInterval(O)}}}
...
}if(this.hasSilverlight(true)){j.push("universal:asx");
j.push("universal:ism");
j.push("universal:wm")
}break;
...
},hasMpegDash:function(){return typeof(window.MediaSource)==="function"||typeof(window.WebKitMediaSource)==="function"
...
$pdk.bootloaderVersion=new $pdk.PdkVersion("5","5","9","372962","2014-11-24 9:37 AM");
...
$pdk.shell.Factory.CLASS_TABLE={tpNavigation:b.Navigation,tpSearch:b.Search,tpReleaseList:b.ReleaseList,tpReleaseModel:b.ReleaseModel,tpPlayer:b.Player,tpCategoryList:b.CategoryList,tpClipInfo:b.ClipInfo,tpCategoryModel:b.CategoryModel,tpHeader:b.Header};
...
a.setAudioTrackByLanguage=function(d,c){this._regFunc("setAudioTrackByLanguage",["java.lang.String"],[d],c)
};
a.setPlayerLayoutXml=function(c,d){this._regFunc("setPlayerLayoutXml",["java.lang.String"],[c],d)
};
...
a.setAudioTrackById=function(d,c){this._regFunc("setAudioTrackById",["int"],[d],c)
};
...
a.setPlayerLayoutUrl=function(c,d){this._regFunc("setPlayerLayoutUrl",["java.lang.String"],[c],d)
};
